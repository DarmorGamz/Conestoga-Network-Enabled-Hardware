...
<body>
    <?php
        ...
        try {
            ...
            $sInsert = $oFeedbackDb->prepare('INSERT INTO feedback (name, email, postal_code, message) VALUES (?, ?, ?, ?)');
            $sInsert->execute([$name, $email, $postal_code, $message]);

        } catch(PDOException $e) {
            // DO something. i dont care currently.
        }
